...
(function() {
  ...
  punishCommand = (function(_super) {
    ...
    punishCommand.prototype.getPunishment = function(username) {
      ...
      punishments = ["/me rubs sandpaper on @{victim}'s scrotum", "/me pokes @{victim} in the eyes", "/me throws sand in @{victim}'s eyes", "/me makes @{victim}'s mother cry", "/me penetrates @{victim} with a sharpie", "/me pinches @{victim}'s nipples super hard", "/me gives @{victim} a wet willy", "/me slaps @{victim}", "/me hits @{victim} over the head with a baseball bat", "/me curses @{victim} unborn children", "/me uppercuts @{victim} ", "/me kicks @{victim} in the shins", "/me gives @{victim} a dead leg",  "/me gives @{victim} a dead arm", "/me makes a joke about @{victim}'s Momma", "/me punchs @{victim} in the mouth",  "/me pushes @{victim} under a bus", "/me shoots @{victim} in the chest"];

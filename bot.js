...
(function() {
      ...
      if (msg.length > 9) {
        ...
        switch (param) {
          ...
          case "rapes pup":
            ...
            break;
          case "icecream":
            resp = "order some delicious icecream.  simply say 'icecream' or give some to someone else by saying 'icecream @user'";
          case "taco":
  ...
  icecreamCommand = (function(_super) {
    ...
    icecreamCommand.prototype.randomIcecream = function() {
      var r, icecream;
      tacos = ["Strawberry Sunday", "Chocolate Chip Icecream Cone", "Cookie Dough Triple Scoop ", "Mint Chocolate Chip Icecream Cone", "Chocolate Icecream Sunday", "Banana Split with Whipped Cream", "Vanilla Icecream Cone with Sprinkles ", "Bubblegum Flavored Popcicle"];
